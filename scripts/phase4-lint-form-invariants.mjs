#!/usr/bin/env node
/**
 * phase4-lint-form-invariants.mjs — Phase 4 / Story 4.2 form invariants gate.
 *
 ...
 * ## Usage
 *
 *   node scripts/phase4-lint-form-invariants.mjs [--help] [--preset-path <p>]
 *
...
const USAGE = `Usage:
  node scripts/phase4-lint-form-invariants.mjs [--help]
