/**
 * `social-search-sentry.spec.ts` — Locks the Epic 6.2 Sentry
 * breadcrumb contract (TKT-6.2.H1).
 *
 * Coverage:
 *   - `EPIC_6_2_BREADCRUMB_CATEGORY` is exactly "social:6.2".
 *   - `SOCIAL_EPIC_6_2_VERSION` is exactly "1.0.0".
 ...
 *   - The breadcrumb category is exactly `social:6.2` for every
 *     emitted event.
 *
