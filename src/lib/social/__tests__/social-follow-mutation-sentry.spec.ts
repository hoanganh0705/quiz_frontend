/**
 * `social-follow-mutation-sentry.spec.ts` — locks the Phase 6.6 Sentry breadcrumb contract
 * (TKT-6.6.G1).
 *
 * Coverage:
 *   - `EPIC_6_6_BREADCRUMB_CATEGORY === "social:6.6"`
 *   - `SOCIAL_EPIC_6_6_VERSION === "1.0.0"`
...
// ─── Mock Sentry ─────────────────────────────────────────────────────
// Must use vi.hoisted because social-follow-mutation-sentry.ts imports Sentry at
