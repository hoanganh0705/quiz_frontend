/**
 * Spec for `phase6_6_10_sentry.ts` (TKT-6.10.G2).
 *
...
describe("phase6:6.10 Sentry breadcrumb helpers (TKT-6.10.G2)", () => {
  describe("phase6Social10MalformedPayloadBreadcrumb", () => {
    it("emits a breadcrumb with category 'phase6:6.10:malformed-payload'", () => {
    ...
    it("includes the epic version", () => {
      ...
      expect(breadcrumbCalls[0]?.data["epic"]).toBe(EPIC_6_10_VERSION);
    });
  ...
  describe("phase6Social10SelfActionRejectionBreadcrumb", () => {
    it("emits a breadcrumb with category 'phase6:6.10:self-action-rejection'", () => {
  ...
  describe("phase6Social10SequenceGuardDropBreadcrumb", () => {
    it("emits a breadcrumb with category 'phase6:6.10:sequence-guard-drop'", () => {
  ...
  describe("addReconnectReconciliationBreadcrumb", () => {
    it("emits a breadcrumb with category 'phase6:6.10:reconnect-reconciliation'", () => {
      addReconnectReconciliationBreadcrumb({
  ...
  describe("addSocialRealtimeBreadcrumb (canonical helper)", () => {
    it("emits a breadcrumb with category 'phase6:6.10'", () => {
