/**
 * `social-mutuals-sentry.spec.ts` — Locks the Epic 6.4 Sentry
 * breadcrumb contract (TKT-6.4.H1).
 *
 * Coverage:
 *
 *   - `EPIC_6_4_BREADCRUMB_CATEGORY` is exactly "social:6.4".
 *   - `SOCIAL_EPIC_6_4_VERSION` is exactly "1.0.0".
 ...
 *   - The breadcrumb category is exactly `social:6.4` for every
 *     emitted event.
