/**
 * `social-follow-mutation-sentry.ts` — Phase 6.6 Sentry breadcrumb helpers.
 *
 ...
 * ## Purpose
 *
 * Centralised helpers for the `social:6.6` Sentry breadcrumb category
...
/**
 * Emit a `social:6.6` breadcrumb for a follow / unfollow mutation.
 *
 * @example
 *   // Successful follow
