/**
 * `social-search-sentry.ts` — Phase 6.2 Sentry breadcrumb helpers.
 *
 ...
 * ## Purpose
 *
 * Centralised helpers for the `social:6.2` Sentry breadcrumb category
 ...
 * use to emit breadcrumbs; the `social-lint-invariants` script
 ...
 * `social:6.1` category. Phase 6.2 introduces read-side list
...
/**
 * Emit a `social:6.2` breadcrumb for a social list page data fetch.
 *
 * @example
...
/**
 * Emit a `social:6.2` breadcrumb for the social counts badge data
