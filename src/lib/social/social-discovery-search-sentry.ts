/**
 * `social-discovery-search-sentry.ts` — Phase 6.7 Sentry breadcrumb helpers.
 *
 ...
 * ## Purpose
 *
 * Centralised helpers for the `social:6.7` Sentry breadcrumb category that
...
/**
 * Emit a `social:6.7` breadcrumb for a block / unblock mutation.
 *
 * @example
 *   // Successful block
