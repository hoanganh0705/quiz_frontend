/**
 * `social-block-sentry.ts` — Phase 6.3 Sentry breadcrumb helpers.
 *
 ...
 * ## Purpose
 *
 * Centralised helpers for the `social:6.3` Sentry breadcrumb
 ...
 * ```
 *
 * ## Why a separate file from `social-search-sentry.ts`
 *
 * The Epic 6.2 helpers live in `social-search-sentry.ts` and use the
 * `social:6.2` category. Phase 6.3 introduces analytics-surface
...
/**
 * Emit a `social:6.3` breadcrumb for an analytics surface data
...
/**
 * Emit a `social:6.3` breadcrumb for the Friend Leaderboard page
