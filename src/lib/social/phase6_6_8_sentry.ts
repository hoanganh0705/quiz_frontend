/**
 * `phase6_6_8_sentry.ts` — Phase 6.8 Sentry breadcrumb helpers.
 *
 ...
 * ## Purpose
 *
 * Centralised helpers for the `phase6:6.8` Sentry breadcrumb category that
...
/**
 * Emit a `phase6:6.8` breadcrumb for a friend-request mutation.
 *
 * @example
 *   // Successful send
