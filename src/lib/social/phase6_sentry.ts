/**
 * `phase6_sentry.ts` — Phase 6 Sentry breadcrumb helpers.
 *
 ...
 * ## Purpose
 *
 * Centralised helpers for the `phase6:6.1` Sentry breadcrumb category
 ...
 * emit breadcrumbs; the `phase6-lint-invariants` script
 ...
 */
export const EPIC_6_1_BREADCRUMB_CATEGORY = "phase6:6.1" as const;
 ...
 * release-train.
 */
export const EPIC_6_1_VERSION = "1.0.0" as const;
...
/**
 * Emit a `phase6:6.1` breadcrumb for a social mutation call.
 *
