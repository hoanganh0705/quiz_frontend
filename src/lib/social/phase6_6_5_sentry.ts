/**
 * `phase6_6_5_sentry.ts` — Phase 6.5 Sentry breadcrumb helpers.
 *
 ...
 * ## Purpose
 *
 * Centralised helpers for the `phase6:6.5` Sentry breadcrumb
 ...
 */
export const EPIC_6_5_BREADCRUMB_CATEGORY = "phase6:6.5" as const;
 ...
 */
export const EPIC_6_5_VERSION = "1.0.0" as const;
...
/**
 * Emit a `phase6:6.5` breadcrumb for a discovery-service data fetch.
 *
 * @example
...
/**
 * Emit a `phase6:6.5` breadcrumb for a search-service data fetch.
 *
 * @example
