/**
 * `phase6_6_4_sentry.ts` — Phase 6.4 Sentry breadcrumb helpers.
 *
 ...
 * ## Purpose
 *
 * Centralised helpers for the `phase6:6.4` Sentry breadcrumb
 ...
 * `phase6-lint-invariants` script asserts that no caller bypasses
 * them.
 *
 ...
 * `phase6:6.1` category. Story 6.4 introduces the mutual- and
 ...
 */
export const EPIC_6_4_BREADCRUMB_CATEGORY = "phase6:6.4" as const;
 ...
 */
export const EPIC_6_4_VERSION = "1.0.0" as const;
...
/**
 * Emit a `phase6:6.4` breadcrumb for a mutual-service data fetch.
...
/**
 * Emit a `phase6:6.4` breadcrumb for an activity-service data fetch.
 * The shape mirrors the Epic 6.2 service breadcrumb pattern
 * (`route` is a stable SDK function name) and extends it with the
