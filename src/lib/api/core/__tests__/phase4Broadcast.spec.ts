/**
 * Phase 4 facade — co-located spec.
 *
 * Source epic:   Epic 4.1.
 * Source ticket: TKT-4.1.B2.
 *
 * Locks the facade's discriminated-union contract. Verifies that
 * `emitPhase4Broadcast` routes each `type` to the right per-feature
 * channel without surfacing new states.
 */
