...
const recentActivity = [
  ...
  { id: 5, action: 'Quiz flagged for review', user: 'AutoMod', time: '3 hours ago' }
]

const quickLinks = [
  { label: 'Manage Categories', href: '/admin/categories', description: 'Add, edit, or remove categories' },
  { label: 'Manage Tags', href: '/admin/tags', description: 'Organize quiz tags' },
  { label: 'Manage Quizzes', href: '/admin/quizzes', description: 'Review and moderate quizzes' },
  { label: 'Manage Users', href: '/admin/users', description: 'User accounts and permissions' }
]
