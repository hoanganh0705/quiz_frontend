/**
 * `mutual-followers-route.spec.tsx` — Locks the App Router route
 * shell for `/social/users/[id]/mutual-followers`.
 *
 ...
 *     a UUID.
 *   - The route delegates to `<MutualsRouteGate kind="followers"
...
describe("/social/users/[id]/mutual-followers route shell", () => {
  ...
  it("is exported as an async default function", async () => {
    const routeModule = await import(
      "@/app/social/users/[id]/mutual-followers/page"
    );
