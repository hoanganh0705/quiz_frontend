...
import SocialFeedRoute from "@/app/social/feed/page";
...
describe("SocialFeedRoute — placeholder branch (AC #7 initial load, placeholder)", () => {
  it("renders SocialFeedPlaceholder when phase6_social_feed is 'placeholder'", () => {
  ...
  it("renders SocialFeedPlaceholder when phase6_social parent is 'placeholder'", () => {
    mockGetFeatureFlagValue.mockImplementation((flag: string) => {
