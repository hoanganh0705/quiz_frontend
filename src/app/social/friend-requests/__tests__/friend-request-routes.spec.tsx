 ...
 * `phase6_social` + `phase6_social_relationship` feature flags plus
...
import IncomingFriendRequestsRoute from "@/app/social/friend-requests/incoming/page";
import OutgoingFriendRequestsRoute from "@/app/social/friend-requests/outgoing/page";
...
describe("IncomingFriendRequestsRoute", () => {
  ...
  describe("placeholder branch", () => {
    it("renders FriendRequestEmptyState when phase6_social is placeholder", () => {
    ...
    it("renders FriendRequestEmptyState when phase6_social_relationship is placeholder", () => {
      mockGetFeatureFlagValue.mockImplementation((name: unknown) => {
        if (name === "phase6_social_relationship") return "placeholder";
        return "live";
      });
