...
/**
 * `/social/friend-requests/incoming` — The viewer's incoming friend
 * requests list.
 *
 * Source epic:   Epic 6.8 — Friend Request Lifecycle.
 * Source story:  `projectDocs/Epics/PHASE_6_IMPLEMENTATION_PLAN.md` →
 *                Story 6.8 (lines 385–428).
 * Source tickets: TKT-6.8.E5 (page component),
 ...
 * `/login?redirect=/social/friend-requests/incoming` by `proxy.ts`
