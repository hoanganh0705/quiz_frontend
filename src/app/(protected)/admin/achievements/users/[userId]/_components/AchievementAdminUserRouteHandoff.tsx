 ...
 * `<AchievementAdminUserPage />` when `admin_achievement_live === 'enabled'`.
 *
 * ## Routing chain
 *
...
/**
 * Placeholder rendered when `admin_achievement_live` is not `'enabled'`.
 ...
 *
 * Reads the `admin_achievement_live` flag and either:
