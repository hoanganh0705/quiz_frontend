/**
 * `comments.service.spec.ts` — locks the comments service contract.
 *
 * Source epic:   Epic 4.1.
 * Source ticket: TKT-4.1.F7.
 *
 * Coverage: pass-through + the four Phase 4 comment error codes the
 * cross-story contract rule calls out (`COMMENT_SELF_VOTE`,
 * `COMMENT_SELF_REPORT`, `COMMENT_REPLY_LIMIT_EXCEEDED`,
