/**
 * `JoinLeaveCta.spec.tsx` — join/leave CTA component.
 *
 ...
 * - shows the sign-in CTA for unauthenticated users
 * - shows the join CTA when canJoin is true
 * - shows the leave CTA when canLeave is true
 * - hides both CTAs when neither permission is granted
 */
