/**
 * `InstanceClosedState.spec.tsx` — terminal-state primitive.
 *
 ...
 * - renders the closed variant by default for `status: 'closed'`
 * - renders the cancelled variant when `cancelled` overrides a closed status
 * - renders the finished variant for `status: 'finished'`
 * - closedAt timestamp is rendered when provided
 */
