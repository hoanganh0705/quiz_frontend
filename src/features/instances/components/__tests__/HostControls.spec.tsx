/**
 * `HostControls.spec.tsx` — host-only start/close controls.
 *
 ...
 *
 * Tests cover:
 * - renders nothing for non-host users
 * - renders start for host + canStart
 * - renders close for host + canClose (running)
