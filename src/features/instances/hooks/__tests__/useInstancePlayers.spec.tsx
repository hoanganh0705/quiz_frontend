/**
 * `useInstancePlayers.spec.tsx` — locks the cursor-paginated instance players hook.
 *
 ...
 * - service forwarding: forwards id
 * - pagination: append without duplicates, hasMore, loadMore
 * - synthesised id alias from userId
 * - typed error mapping surfaces typed ApiError
 */
