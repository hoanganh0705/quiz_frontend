/**
 * `useInstance.spec.tsx` — locks the single-instance detail hook from TKT-5.7.B1.
 *
 ...
 *
 * Tests cover:
 * - feature flag placeholder: safe fallback, no service call
 * - service forwarding returns synthesised InstanceDetail with `id` alias
 * - typed error code mapping surfaces typed `ApiError` for each INSTANCE_* code
 * - null instanceId short-circuits to safe fallback
 */
