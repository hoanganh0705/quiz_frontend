/**
 * `useLeaveInstance.spec.tsx` — locks the leave mutation hook from TKT-5.7.B4.
 *
 ...
 *
 * Tests cover:
 * - feature flag placeholder: no socket emit
 * - null instanceId: no socket emit
 * - success path: state transitions to success
 * - error path: typed errors surface
 * - double-click guard
 * - reset clears state
 */
