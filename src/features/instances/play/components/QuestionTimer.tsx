...
/**
 * `QuestionTimer` — server-authoritative answer-window timer.
 *
 ...
 *
 * Renders the countdown sourced exclusively from `useQuestionTimer`.
 * Shows `GameStaleState` when `isStale === true` and
 * `GameConnectionStatus` when the gameplay socket is not `connected`.
 * No client-side start/stop of the answer window.
 */
