...
/**
 * `QuestionCard` — player-safe question display.
 *
 ...
 *
 * Renders the current player-safe question bundle from `useQuestionRevealed`.
 * Shows `GameSkeleton` while loading and `GameEmptyState` while no question
 * has been revealed yet. The component never renders author-only correctness
 * fields (`isCorrect`, `explanation`, `solution`, `correctOptionId`).
 */
