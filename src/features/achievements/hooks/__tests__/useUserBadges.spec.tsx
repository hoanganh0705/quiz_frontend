/**
 * `useUserBadges.spec.tsx` — locks the public user badge profile hook
 * with privacy gating from TKT-5.5.B6.
 *
 ...
 * - Null `userId` fallback.
 * - Privacy gating via `ACHIEVEMENT_FORBIDDEN` → `isPrivate: true`.
 * - Public profile projection (featuredBadges, totalBadges, rareBadges,
 *   highestRank).
 */
...
describe("useUserBadges", () => {
  ...
  it("projects a public user badge profile", async () => {
    ...
    // Privacy-aware flag is exposed at the hook surface, not on the
