/**
 * `useBadge.spec.tsx` — locks the single badge detail hook from
 * TKT-5.5.B5.
 *
 ...
 * - Null `code` fallback.
 * - Service forwarding.
 * - Privacy gating via `BADGE_HIDDEN` (tombstone view).
 * - `BADGE_DEFERRED` surfaces as error but NOT isPrivate (UI must
 *   never claim a deferred badge as earned).
 */
