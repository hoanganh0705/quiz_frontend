...
/**
 * `CollectionAnalyticsPanel` — analytics panel for the collection detail page.
 *
 * Source epic:   Epic 4.7 — Collection detail + bulk add/remove + analytics.
 * Source ticket: EPIC-4.7-B3-6.
 *
 * ## What this component owns
 *
 *   - Displays total quiz count.
 *   - Shows average quiz rating.
 *   - Displays top categories and tags.
 *   - Loading skeleton state.
 *   - Empty state: "Analytics will populate after activity."
...
interface CollectionAnalyticsPanelProps {
  ...
  isLoading?: boolean;
  /** Whether analytics are empty (no activity yet). */
  isEmpty?: boolean;
...
/**
 * CollectionAnalyticsPanel component.
 *
 * Features:
 * - Displays total quizzes and average rating
 * - Shows top categories and tags
 * - Loading skeleton
