// Re-export types and BADGE_TYPES constant from canonical types location
export { BADGE_TYPES } from '@/features/leaderboard/types'
export type { BadgeType, LeaderboardEntry } from '@/features/leaderboard/types'
import { BADGE_TYPES } from '@/features/leaderboard/types'
