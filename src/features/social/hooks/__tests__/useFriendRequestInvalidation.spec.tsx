/**
 * Spec for `useFriendRequestInvalidation` (TKT-6.10.E2).
 *
 * Source epic:   Epic 6.10 — Realtime Social Notifications and Relationship
 *                Invalidation.
 * Source ticket: TKT-6.10.E2.
 *
 * Locks the friend-request listener hook contract:
 *   - Flag-placeholder fallback (no socket, no listener registered).
 *   - Each of the five event names dispatches its documented
 *     `mutateCarefully` set per the Epic 6.8.G3 deferral note table.
 *   - Each event posts a `friend-request-invalidation` cross-tab
 *     envelope.
