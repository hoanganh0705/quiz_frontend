/**
 * Spec for `useSocialFeedInvalidation` (TKT-6.10.E5).
 *
 * Source epic:   Epic 6.10 — Realtime Social Notifications and Relationship
 *                Invalidation.
 * Source ticket: TKT-6.10.E5.
 *
 * Locks the feed-invalidation listener hook contract:
 *   - Flag-placeholder fallback.
 *   - Null viewer-user-id fallback.
 *   - Successful dispatch invalidates `makeFeedKey(viewerUserId)`.
