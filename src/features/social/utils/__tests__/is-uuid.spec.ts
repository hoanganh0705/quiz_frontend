/**
 * `is-uuid.spec.ts` — Locks the UUID shape check used by the Story
 * 6.2 list routes.
 *
 * Source epic:   Epic 6.2.
 * Source ticket: TKT-6.2.B1 (route scaffold 404 contract).
 */
...
describe("isUuid", () => {
  ...
  it("rejects non-UUID-shaped strings", () => {
    ...
    expect(isUuid("00000000-0000-4000-8000-00000000000")).toBe(false); // too short
    expect(isUuid("00000000-0000-4000-8000-0000000000000")).toBe(false); // too long
