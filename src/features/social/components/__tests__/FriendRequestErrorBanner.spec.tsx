/**
 * `FriendRequestErrorBanner.spec.tsx` — locks the
 * `FriendRequestErrorBanner` contract (TKT-6.8.E10).
 *
 * Coverage:
 *
 *   - Renders nothing when error is null
 *   - Renders code-specific copy for known codes
 *   - Renders generic fallback for unknown codes
 *   - Renders a retry button when the registry has an action label
 *   - ARIA role="alert"
 */
