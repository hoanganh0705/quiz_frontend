/**
 * `FeedLoadMore.spec.tsx` — Locks the load-more affordance contract
 * (TKT-6.9.F6).
 *
 * Asserts:
 *
 *   - `hasMore === false` renders `null`.
 *   - The default branch renders an enabled "Load more" button.
 *   - The loading branch renders a disabled "Loading..." button
 *     with the pending indicator.
 *   - The rate-limited branch renders a disabled "Try again in N
 *     seconds" button with a countdown.
 *   - Clicking the "Load more" button invokes `onLoadMore`.
 *   - The countdown decrements every second.
 */
