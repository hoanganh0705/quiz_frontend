/**
 * `SearchEmptyState.spec.tsx` — Locks the search empty-state contract
 * (TKT-6.5.B3).
 *
 * Asserts:
 *
 *   - `empty-query` renders the "Start typing" copy.
 *   - `query-too-short` renders the "Query too short" copy with the query.
 *   - `no-results` renders the "No results" copy with the query.
 *   - `no-trending` renders the "No trending" copy.
 *   - The `data-kind` attribute matches the prop.
 */
