/**
 * `ActivityEmptyState.spec.tsx` — Locks the activity empty-state
 * contract (TKT-6.4.B4).
 *
 * Asserts:
 *
 *   - Renders the documented default copy when `isBlocked` is
 *     false (or omitted).
 *   - Renders the documented blocked copy when `isBlocked` is true.
 *   - The `data-blocked` attribute matches the prop.
 */
