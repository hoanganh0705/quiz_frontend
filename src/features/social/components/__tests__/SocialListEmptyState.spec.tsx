/**
 * `SocialListEmptyState.spec.tsx` — Locks the empty-state copy
 * contract (TKT-6.2.C3).
 *
 * Asserts:
 *
 *   - Each `kind` renders its documented copy.
 *   - The owner variant for `followers` differs from the non-owner
 *     variant.
