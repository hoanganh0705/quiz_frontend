/**
 * `useMarkNotificationRead.spec.tsx` — locks the mark-read mutation hook.
 *
 ...
 *
 * Tests cover:
 * - success path: state transitions, SWR keys invalidated, double-click guard
 * - error path: typed ApiError surfaces
