/**
 * `NotificationPreferencesForm.spec.tsx` — RTL integration tests for the form.
 *
 ...
 * - empty state renders when preferences are null
 * - all toggles render
 * - save success message appears after successful update
 * - save error banner appears after a failed update
 */
