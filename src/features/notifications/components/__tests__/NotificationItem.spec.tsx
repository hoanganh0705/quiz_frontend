/**
 * `NotificationItem.spec.tsx` — RTL integration tests for the notification row.
 *
 ...
 * - mark-read toggle button triggers markRead mutation
 * - mark-unread toggle button triggers markUnread mutation
 * - delete button triggers delete mutation
 * - hideDelete suppresses the delete affordance
 * - row click navigates to action target when present
 */
