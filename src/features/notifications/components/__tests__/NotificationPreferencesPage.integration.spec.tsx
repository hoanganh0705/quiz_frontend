/**
 * `NotificationPreferencesPage.integration.spec.tsx` — page-level integration tests.
 *
 ...
 *
 * Tests cover:
 * - renders the form when feature flag is live
 * - renders the placeholder when feature flag is placeholder
 * - back link points to /notifications
 * - heading renders
 */
