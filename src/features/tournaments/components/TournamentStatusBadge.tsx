...
/**
 * `TournamentStatusBadge` — compact status indicator for tournaments.
 *
 * Source epic:   Epic 5.1 — SDK coverage & realtime contract foundation.
 * Source story:  5.2 — Tournament discovery and read-only detail surfaces.
 * Source ticket: TKT-5.2.D1.
 *
 * ## What this component owns
 *
 * - Renders a compact, accessible status badge with color-coded pill and text.
 * - Status values come from the server — no countdown or client-side advancement.
 */
...
export interface TournamentStatusBadgeProps {
  /** Tournament status from the server. */
