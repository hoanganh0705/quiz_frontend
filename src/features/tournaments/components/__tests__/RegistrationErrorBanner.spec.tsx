/**
 * `RegistrationErrorBanner.spec.tsx` — integration tests for the registration error banner.
 *
 ...
 *
 * Tests cover:
 * - All 9 error codes render non-empty copy
 * - `null` error renders nothing
 * - `ALREADY_REGISTERED` renders info style
