/**
 * `TournamentRegistrationCta.spec.tsx` — integration tests for the registration CTA.
 *
 ...
 * - Authenticated registered → "Withdraw" button
 * - Pending → both buttons disabled
 * - ALREADY_REGISTERED → info banner
 * - TOURNAMENT_FULL → error banner
 * - Ineligible → renders nothing
 * - Feature flag placeholder → renders nothing
 */
...
// Mock the useTournamentRegistration hook
