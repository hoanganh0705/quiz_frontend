...
/**
 * `TournamentStaleState` — stale-data indicator banner for tournament surfaces.
 *
 * Source epic:   Epic 5.1 — SDK coverage & realtime contract foundation.
 * Source story:  5.2 — Tournament discovery and read-only detail surfaces.
 * Source ticket: TKT-5.2.C1.
 *
 * Renders a warning-style banner that appears above cached content when
 * revalidation fails. Does not obstruct the stale cached content.
 */
