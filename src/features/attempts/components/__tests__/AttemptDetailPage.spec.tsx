/**
 * `AttemptDetailPage.spec.tsx` — locks the read-only attempt detail page.
 *
 ...
 * Coverage contract:
 *
 *   - Score, breakdown, and feedback render in order.
 *   - Loading skeleton renders during the first fetch.
 *   - No-result fallback renders with a back-to-history link.
 *   - Not-found and forbidden render the redirecting placeholder.
 *   - Validation error and generic error banners render with retry + back.
 *   - No review CTA is rendered.
