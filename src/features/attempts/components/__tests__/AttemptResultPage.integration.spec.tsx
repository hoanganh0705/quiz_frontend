/**
 * `AttemptResultPage.integration.spec.tsx` — integration tests for the
 * `<AttemptResultPage />` page composition.
 *
 ...
 * ## Coverage contract
 *
 *   - Runner handoff: result page renders score, breakdown, feedback, review CTA.
 *   - ATTEMPT_NOT_ACTIVE swap-on without toast spam.
 *   - ATTEMPT_NOT_FOUND / ATTEMPT_FORBIDDEN toast + redirect to /quizzes.
 *   - ATTEMPT_VALIDATION_FAILED inline banner, runner stays mounted.
 *   - 429 / 5xx retry banner.
 *   - No client-side scoring, no author DTO, no pre-completion review DTO.
 */
