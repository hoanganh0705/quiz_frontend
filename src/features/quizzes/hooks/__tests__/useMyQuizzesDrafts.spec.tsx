/**
 * `useMyQuizzesDrafts.spec.tsx` — unit tests for the `useMyQuizzesDrafts` hook.
 *
 * Source epic:   Epic 4.4 — Authored quizzes list + analytics.
 * Source ticket: TKT-4.4.E4.
 *
 * Mirror of `useMyQuizzes.spec.tsx` (TKT-4.4.E3) for the drafts endpoint.
 * The hook calls `getMyQuizzesDrafts`; the SWR key uses `'drafts'`.
 */
