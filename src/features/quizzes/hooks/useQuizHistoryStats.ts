/**
 * `useQuizHistoryStats` — wraps `GET /users/me/quiz-history/stats`.
 *
 * Phase 5 (S-29): returns the user-attempt-stats aggregate for the
 * dashboard. The shape returned by the backend is the existing
 * `UserAttemptStatsResponseDto`; this hook exposes it directly plus a
 * loading / error state for the editor.
 */
'use client';
