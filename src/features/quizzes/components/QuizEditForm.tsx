/**
 * `QuizEditForm` — metadata edit form for a quiz version.
 *
 * Source epic:   Epic 4.9 — Quiz version lifecycle + edit version metadata.
 * Source ticket: TKT-4.9.14.
 *
 * ## What this component renders
 *
 * - Form fields: difficulty, duration, passing score, XP reward
 * - Submit button with loading state
 * - Error handling
 *
 * ## What this component does NOT own
 *
 * - Quiz metadata (title, description) — owned by quiz-level form (future)
 * - Question editing — owned by story 4.10
 */
...
/**
 * `<QuizEditForm />` — renders the version metadata edit form.
 *
 * @example
 * ```tsx
 * <QuizEditForm
 ...
 *   versionId="uuid"
 *   initialData={version}
 *   onSave={async (data) => await updateVersion(data)}
 *   isSaving={isSaving}
 * />
 * ```
 */
export const QuizEditForm = memo(function QuizEditForm({
  ...
  // TODO (TKT-4.9.14): Implement form with react-hook-form + zod validation
  // For now, this is a stub that renders the version details.
  ...
  // Map difficulty from the detail response
