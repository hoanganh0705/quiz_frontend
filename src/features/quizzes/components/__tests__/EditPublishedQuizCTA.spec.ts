/**
 * `EditPublishedQuizCTA.spec.ts` — unit tests for EditPublishedQuizCTA.
 *
 * Source epic:   Epic 4.11 — Quiz publish flow + edit-published-as-new-draft.
 * Source ticket: T-4.11.14.
 *
 * Tests the EditPublishedQuizCTA component using node environment
 * (no DOM rendering, so no jsdom environment issues).
 * Tests cover the core hook interaction patterns without full DOM rendering.
 */
...
// Mock the useCreateVersion hook
