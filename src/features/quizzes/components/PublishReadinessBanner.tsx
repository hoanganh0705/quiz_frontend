/**
 * `PublishReadinessBanner` — shows publish readiness status.
 *
 * Source epic:   Epic 4.9 — Quiz version lifecycle + edit version metadata.
 * Source ticket: TKT-4.9.17 (placeholder).
 *
 * ## What this component renders
 *
 * - Progress bar showing question count vs required (5)
 * - Status indicator (ready/not ready)
 * - CTA buttons for publish and add questions
 *
 * ## What this component does NOT own
 *
 * - The actual publish action (caller handles `onPublish`)
 * - Navigation to question editor (caller handles `onAddQuestions`)
 *
 * ## Note
 *
 * This is a placeholder that will be enhanced in Epic 4.11.
 */
...
export interface PublishReadinessBannerProps {
  ...
  minQuestions?: number;
  /** Whether the version is ready to publish. */
  isReady: boolean;
  ...
  /** `true` to show the banner (can be dismissed). */
  isVisible?: boolean;
