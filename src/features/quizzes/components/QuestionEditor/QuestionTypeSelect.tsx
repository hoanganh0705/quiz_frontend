/**
 * `QuestionTypeSelect` — question type selector for the editor.
 *
 * Source epic:   Epic 4.10 — Question editor (single + bulk).
 * Source ticket: T-4.10.13.
 *
 * ## What this component owns
 *
 * - **Type selection** — radio-style card selector for question types.
 * - **Visual cards** — shows icon, label, and description for each type.
 ...
 * |------|-------|-------------|
 * | single_choice | Single choice | One correct answer from multiple options |
 * | multiple_choice | Multiple choice | Multiple correct answers allowed |
 * | true_false | True/False | Binary choice question |
 * | short_answer | Short answer | Text answer, auto-graded |
 *
...
/**
 * `<QuestionTypeSelect />` — radio-style card selector for question types.
 */
