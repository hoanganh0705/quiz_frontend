/**
 * `QuestionEditorEmptyState` — empty state for the question editor.
 *
 ...
 * - "No questions yet" messaging.
 * - Call-to-action suggestion.
 *
 * @see `PublishReadinessCounter` — the counter that displays the requirement
 */
...
export interface QuestionEditorEmptyStateProps {
  ...
  minRequired?: number;
  /** Callback when user clicks to add first question. */
  onAddQuestion?: () => void;
...
/**
 * `<QuestionEditorEmptyState />` — shown when a version has no questions.
 */
