...
/**
 * `useMyProfileBundlePage()` — read-side hook for the
 * `/my-profile` page (Phase 4 / S-25). Composes the slim
 * identity from the user store + the `/users/me/profile`
 * bundle to derive the page's display fields.
 */
