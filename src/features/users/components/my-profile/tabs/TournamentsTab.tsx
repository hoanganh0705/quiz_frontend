/**
 * `TournamentsTab` — displays tournaments, history, and analytics.
 *
 * Source epic:   Epic 4.5 — Personal activity feed + ranking + badges + tournament history + my-attempts list.
 * Source ticket: T-4.5-D3.
 *
 * Rewrites TournamentsTab to display:
 * - Active tournaments
 * - Tournament history with cursor pagination
 * - Analytics sparkline (hidden if all zeros)
 */
...
/**
 * Formats tournament status for display.
 */
...
/**
 * Tournaments tab with active tournaments, history, and analytics.
 */
