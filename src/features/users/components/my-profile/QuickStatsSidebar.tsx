/**
 * `QuickStatsSidebar` — displays key stats in a sticky sidebar.
 *
 * Source epic:   Epic 4.5 — Personal activity feed + ranking + badges + tournament history + my-attempts list.
 * Source ticket: T-4.5-E1.
 *
 * Displays key stats from live data sources:
 * - Total XP from useMyAnalytics
 * - Global rank from useMyRanking
 * - Quizzes completed from useMyAnalytics
 * - Tournament stats from useMyTournamentAnalytics
 */
...
/**
 * Props for QuickStatsSidebar component.
 */
...
/**
 * Quick stats sidebar with live data from hooks.
 */
