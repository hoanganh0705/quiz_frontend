/**
 * `TournamentSparkline` — displays tournament analytics as a sparkline.
 *
 * Source epic:   Epic 4.5 — Personal activity feed + ranking + badges + tournament history + my-attempts list.
 * Source ticket: T-4.5-C (sparkline component).
 *
 * Displays count, winRate, averageRank in a compact card format.
 * Hidden if all values are zero (per user plan §1.3).
 */
...
/**
 * Props for TournamentSparkline component.
 */
...
/**
 * Checks if sparkline should be hidden (all values zero).
 * Note: 30-day check would be server-side; client just checks for zeros.
 */
...
/**
 * Formats average rank for display.
 */
...
/**
 * Displays tournament analytics as a compact sparkline.
 */
