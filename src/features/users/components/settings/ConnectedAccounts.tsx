...
/**
 * `ConnectedAccounts` — OAuth account connection section.
 *
 * Source epic:   Epic 4.3 — Edit profile + user settings.
 * Source ticket: TKT-4.3.C5.
 *
 * ## What this component owns
 *
 * Reads `connectedAccounts` from `profile.settings` (passed as prop), renders
 * the list of OAuth providers, and calls
 * `useUpdateMySettings.mutate({ connectedAccounts: updated })` for connect
 * and disconnect actions. The OAuth redirect flow is handled by a standard
 * link — the frontend optimistically updates the account list on confirmation.
 *
