...
interface QuizSettingsConfigurationTabProps {
  values: SettingsValues
  onChange: (next: Partial<SettingsValues>) => void
}

// Wrap component in memo to prevent unnecessary re-renders
const QuizSettingsConfigurationTab = memo(function QuizSettingsConfigurationTab({
  values,
  onChange
}: QuizSettingsConfigurationTabProps) {
  return (
    <Card
...
export default QuizSettingsConfigurationTab
