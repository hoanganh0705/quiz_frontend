/**
 * `SocialReadResultCard.spec.tsx` — locks the read-only social result card.
 *
 ...
 *
 * - Renders stable-ID navigation link.
 * - Renders only read-only fields (displayName, subtitle).
 * - No follow, friend-request, or message CTAs.
 * - No social write DTO imports.
 */
