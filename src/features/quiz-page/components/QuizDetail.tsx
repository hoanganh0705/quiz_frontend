...
import Overview from '@/features/quiz-detail/Overview'
import Leaderboard from '@/features/quiz-detail/Leaderboard'
import Reviews from '@/features/quiz-detail/Reviews'
