/**
 * `UserAchievementHistoryPanel` unit tests.
 *
 * Source epic:   Epic 7.8 — Achievement Admin: Re-evaluate per User and Revoke Badge.
 * Source ticket: TKT-7.8.D4.
 *
 * Coverage map (TKT-7.8.D4 acceptance criteria):
 *
 *   AC #1 — Loading renders HistorySkeleton.
 *   AC #2 — Success with history renders the list with Load more affordance.
 *   AC #3 — Empty history renders empty state.
 *   AC #4 — rateLimitedUntil set hides Load more; friendly notice renders.
 *   AC #5 — Error renders typed-code notice.
 */
