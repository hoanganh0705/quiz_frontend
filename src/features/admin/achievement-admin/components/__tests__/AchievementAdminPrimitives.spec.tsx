/**
 * Achievement admin primitive component unit tests.
 *
 * Source epic:   Epic 7.8 — Achievement Admin: Re-evaluate per User and Revoke Badge.
 * Source ticket: TKT-7.8.D5 (a / b / c).
 *
 * Coverage map (TKT-7.8.D5 acceptance criteria):
 *
 *   AC #1  — AchievementAdminSkeleton renders the documented count by default.
 *   AC #2  — AchievementAdminEmptyState renders the documented copy.
 *   AC #3  — AchievementAdminErrorState renders priority-copy for documented codes;
 *            RequestIdBanner renders when error.requestId is present.
 *   AC #4  — none of the primitives call services.
 */
