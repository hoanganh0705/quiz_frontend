...
/**
 * `features/admin/category-admin/components/CategoryAdminSkeleton.tsx`
 *
 ...
 *
 * Mirrors `TagAdminSkeleton` (TKT-7.3.D3) but renders the larger
 * category card (with image area and description line).
 */
