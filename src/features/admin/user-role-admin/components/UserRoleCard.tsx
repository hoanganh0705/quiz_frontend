...
/**
 * `features/admin/user-role-admin/components/UserRoleCard.tsx`
 *
 ...
 *
 * The user role card showing the target user's details and current roles.
 * Includes:
 *   - User header (avatar, username, email, user id)
 *   - Role list with Revoke buttons
 *   - Grant Role button
 *   - Loading skeleton
 *   - Empty state
...
export interface UserRoleCardProps {
  ...
  /** Called after a successful grant or revoke */
  onChanged?: () => void;
}

/**
 * Card showing the target user's details and current roles.
 */
