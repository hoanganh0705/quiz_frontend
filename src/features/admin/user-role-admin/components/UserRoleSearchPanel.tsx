...
/**
 * `features/admin/user-role-admin/components/UserRoleSearchPanel.tsx`
 *
 ...
 *
 * The user search panel for the user role admin surface:
 *
 ...
 * ## No service calls
 *
 * This component delegates all search logic to the `useUserSearch` hook.
...
export function UserRoleSearchPanel({
  ...
  const handleRetry = () => {
    // Trigger revalidation by re-setting the query
    const currentQuery = query;
    setQuery('');
    // Small delay to ensure the state update propagates
