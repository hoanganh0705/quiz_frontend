/**
 * `__tests__/review-moderation-cache-keys.spec.ts`
 *
 ...
 * every consumer hook (`useResolveReviewReport`, etc.) calls. The
 * specs cover the four documented acceptance criteria:
 *
