/**
 * `CommentReportsList.spec.tsx` — unit tests for the queue's list
 * container.
 *
 * Source epic:   Epic 7.6 — Comment Moderation (Hide, Restore, and Report Queue).
 * Source ticket: TKT-7.6.E3.
 *
 * Coverage contract (TKT-7.6.E3 acceptance criteria):
 *
...
// Helper to silence unused-arg lint for the imported `CommentReportConsumerAction`
// alias above. The import is intentional; the type is referenced via the
// `onAction` callback in the spec signature.
