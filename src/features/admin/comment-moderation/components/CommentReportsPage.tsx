...
/**
 * `features/admin/comment-moderation/components/CommentReportsPage.tsx`
 *
 * Source epic:   Epic 7.6 — Comment Moderation (Hide, Restore, and Report Queue).
 * Source tickets: TKT-7.6.A3 (placeholder) → TKT-7.6.F1
 *   (full composition).
 *
 ...
 *     reads from `useCommentReports` (E3) or props.
 ...
 *
 * Exports:
 *   - `CommentReportsPage` — no props required.
 *   - `CommentReportsPageProps` — the props interface (currently
