        ...
        <div className='xl:w-full container'>
          ...
          >
            {winners.map((winner) => (
              <SwiperSlide
                key={winner.id}
                className='shrink-0 px-3 relative overflow-hidden dark:bg-slate-900 bg-[#e2e8f0] border border-border rounded-lg p-4 shadow-lg flex flex-col items-center text-center w-full'
              >
