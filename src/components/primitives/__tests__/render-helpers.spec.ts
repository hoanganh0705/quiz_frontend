/**
 * Stub test for the DTO factory helpers.
 *
 * Source ticket: TKT-3.1.B3.
 *
 * Exercises the pure factory functions only — the render helpers require
 * a DOM environment and are covered by per-primitive specs added in
 * Batches C/D/E.
 *
 * AC reference (TKT-3.1.B3 #3): `pnpm test src/components/primitives/__tests__/render-helpers.spec.ts`
 * passes.
 */
