 ...
 * Source ticket: TKT-3.1.D2.
 *
 * Covers:
 *   - default variant renders without a link wrapper (no <a>).
 *   - clickable variant with slug renders an anchor to /tags/<slug>.
 *   - clickable variant without slug falls back to /tags/<tagId>.
 *
 * `next/link` is mocked so the test runs without a Next.js runtime.
 */
