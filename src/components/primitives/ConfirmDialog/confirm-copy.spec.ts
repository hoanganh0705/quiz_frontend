/**
 * confirm-copy — vocabulary completeness spec.
 *
 * Source epic:   Epic 4.1.
 * Source ticket: TKT-4.1.D1 + TKT-4.1.D3 (this file).
 *
 * Pure-data tests; no React involved.
 */
...
describe('confirm-copy — vocabulary', () => {
  it('exposes exactly the 5 documented variants', () => {
    ...
    // exhaustive: every ConfirmKind has a CONFIRM_COPY entry
  ...
  it("destructive-permanent.body contains a permanence language marker (the word 'permanently')", () => {
    // Either the words "permanently" or "permanent" should appear, per
    // TKT-4.1.D3 acceptance criterion 1.
