...
- Name: bookmarks/bookmark.spec.ts >> Bookmark acceptance (Story 3.10 / TKT-3.10.G2) >> (d) multi-collection user routes the add to the default (Favourites) collection
- Location: e2e/bookmarks/bookmark.spec.ts:245:7
