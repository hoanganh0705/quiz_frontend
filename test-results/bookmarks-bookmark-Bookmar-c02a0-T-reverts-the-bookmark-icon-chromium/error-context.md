...
- Name: bookmarks/bookmark.spec.ts >> Bookmark acceptance (Story 3.10 / TKT-3.10.G2) >> (f3) a 500 INTERNAL_ERROR on the add POST reverts the bookmark icon
- Location: e2e/bookmarks/bookmark.spec.ts:408:7
