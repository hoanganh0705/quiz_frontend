...
- Name: bookmarks/bookmark.spec.ts >> Bookmark acceptance (Story 3.10 / TKT-3.10.G2) >> (b) detail remove is immediate and the unbookmarked state survives a hard reload
- Location: e2e/bookmarks/bookmark.spec.ts:146:7
