...
- Name: bookmarks/bookmark.spec.ts >> Bookmark acceptance (Story 3.10 / TKT-3.10.G2) >> (a) card add is immediate and the bookmarked state survives a hard reload
- Location: e2e/bookmarks/bookmark.spec.ts:97:7
