...
- Name: bookmarks/bookmark.spec.ts >> Bookmark acceptance (Story 3.10 / TKT-3.10.G2) >> (c) zero-collection user opens the setup prompt and no add POST is fired
- Location: e2e/bookmarks/bookmark.spec.ts:204:7
