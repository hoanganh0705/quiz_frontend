...
- Name: bookmarks/bookmark.spec.ts >> Bookmark acceptance (Story 3.10 / TKT-3.10.G2) >> (f1) a 400 BAD_REQUEST on the add POST reverts the bookmark icon
- Location: e2e/bookmarks/bookmark.spec.ts:358:7
